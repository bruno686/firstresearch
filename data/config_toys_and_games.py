# -*- coding: utf-8 -*-
# @Time : 2022/5/16 21:59
# @Author : Bruno
# @File : config_toys_and_games.py
import argparse
import os
...
def get_params():
    ...
    parser.add_argument("--meta_path", type=str, default='/reviews_Toys_and_Games_5.json',
                        help="chi metadata directory")
    parser.add_argument("--data_name", type=str, default='Toys and Games')
