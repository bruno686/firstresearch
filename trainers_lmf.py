# -*- coding: utf-8 -*-
# @Time : 2022/5/19 01:00
# @Author : Bruno
# @File : trainers_lmf.py
import torch
...
class Trainer(torch.nn.Module):
    def __init__(self, DetectNet, LFM, uid_iid_rating):
        ...
        self.gcf = LFM(self.num_uid, self.num_iid).to(self.device)
    ...
    def test(self,test_dataloader):
        for index, batch in enumerate(test_dataloader):
            ...
            rmse = (mean_squared_error(pred_rating,rating))**(1/2)
